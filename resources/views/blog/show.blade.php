                    ...
                    <div class="padding-10">
                        ...
                        <div class="post-meta no-border">
                            <ul class="post-meta-group">
                                ...
                                <li><i class="fa fa-folder"></i><a href="{{route('category',$post->category->slug)}}">{{$author->category}}</a></li>
            ...
            <article class="post-author padding-10">
                <div class="media">
                    ...
                    <a href="{{route('author',$author->slug)}}">
                        <img alt="{{$author->name}}" width=100 height=100 src="{{$author->gavatar()}}" class="media-object">
                    </a>
                    </div>
